    ...
    <>
      ...
      <section className="py-20 bg-black text-white">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-10">
          <div>
            <h3 className="text-xl text-pearl-gold mb-2">Apartment Interior Designers in Hyderabad</h3>
            <p className="text-gray-400">
          ...
          <div>
            <h3 className="text-xl text-pearl-gold mb-2">Villa Interior Designers in Hyderabad</h3>
            <p className="text-gray-400">
          ...
          <div>
            <h3 className="text-xl text-pearl-gold mb-2">Commercial Interior Designers in Hyderabad</h3>
            <p className="text-gray-400">
