...
export default function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      aria-label="Chat with designer on WhatsApp"
      className="fixed bottom-24 right-6 z-[90] hidden md:block"
    >
      <div className="flex items-center gap-3 rounded-full border border-pearl-gold bg-black px-5 py-3 shadow-gold-sm transition-all duration-300 hover:shadow-gold-md">
        <svg
        ...
        <span className="font-medium text-pearl-gold">Chat with Designer</span>
      </div>
    </a>
  );
}
